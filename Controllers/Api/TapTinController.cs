...
namespace coreWeb.Controllers.Api
{
    ...
    public class TapTinController : ControllerBase
    {
        ...
        public IActionResult UploadDoc([FromForm] TapTin doc)
        {
            ...
            if (type.ToLower() != "pdf" && type.ToLower() != "doc" && type.ToLower() != "docx" && type.ToLower() != "xls" && type.ToLower() != "xlsx" && type.ToLower() != "xlsm" && type.ToLower() !=  "jpg" && type.ToLower() != "png" && type.ToLower() != "rar" && type.ToLower() != "zip" && type.ToLower() != "p7b")
            {
