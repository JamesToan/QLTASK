    ...
    public class YeuCauController : Controller
    {
        ...
        public IActionResult Select(int? StateId, int? DichVuId)
        {
            ...
            else if (user.RoleId == 2 || user.RoleId == 3)
            {
                ...
                else
                {
                    ...
                    {
                        var result = _context.YeuCau.Where(e => e.DichVuId == DichVuId && e.StateId == 6 && e.UnitId == userinfo.UnitId)
                                      .Include(e => e.DichVu)
                                      .Include(e => e.NhanSu)
                                      .Include(e => e.States)
                                      .Include(e => e.User)
        ...
        public IActionResult Selectall(int? StateId, int? DichVuId)
        {
            ...
            if (user.RoleId == 1 )
            {
                    ...
                    var result = _context.YeuCau.Where(e => StateId == null && e.StateId != 6
                || e.DichVuId == null && e.StateId != 6 || e.DichVuId == DichVuId && e.StateId != 6)
                .Include(e => e.DichVu)
                .Include(e => e.NhanSu)
                .Include(e => e.States)
                .Include(e => e.User)
            ...
            else if (user.RoleId == 3 || user.RoleId == 2)
            {
                if (userinfo.UnitId == 2)
                {
                    var result = _context.YeuCau.Where(e => StateId == null && e.StateId != 6 && e.UnitId != 1
                                || e.DichVuId == null && e.StateId != 6 && e.UnitId != 1 || e.DichVuId == DichVuId && e.StateId != 6 && e.UnitId != 1)
                                .Include(e => e.DichVu)
                                .Include(e => e.NhanSu)
                                .Include(e => e.States)
                                .Include(e => e.User)
                ...
                {
                    var result = _context.YeuCau.Where(e => StateId == null && e.StateId != 6 && e.UnitId == userinfo.UnitId
                    || e.DichVuId == null && e.StateId != 6 && e.UnitId == userinfo.UnitId || e.DichVuId == DichVuId && e.StateId != 6 && e.UnitId == userinfo.UnitId)
                    .Include(e => e.DichVu)
                    .Include(e => e.NhanSu)
                    .Include(e => e.States)
                    .Include(e => e.User)
