...
namespace coreWeb.Controllers.Api
{
    ...
    public class StatesController : ControllerBase
    {
        ...
        public IActionResult Get()
        {
            ...
            var result = _context.States.SingleOrDefault();
            if (result != null)
            {
                return Ok(result);
            }
        ...
        [HttpPost]
        public IActionResult Add([FromBody] States model)
        {
            try
            {
                var user = new UserClaim(HttpContext);
        ...
        [HttpPost]
        public IActionResult Update([FromBody] States model)
        {
            try
            {
                var user = new UserClaim(HttpContext);
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                var result = _context.States.SingleOrDefault(e => e.Id == id);
                if (result != null) //update
                {
