  ...
  <div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          ...
          <h4 class="page-title">Ngành nghề</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
      ...
      <div class="col-12">
        <div class="card-box table-responsive">
          ...
          >
            ...
            <el-table-column prop="MaNganhNghe" label="Mã" width="150" align="center">
            </el-table-column>
            <el-table-column
              prop="TenNganhNghe"
    ...
    >
      <el-form
        ...
        label-width="150px"
      >
        <el-form-item label="Mã Ngành nghề" prop="MaNganhNghe">
          <el-input
            v-model="formData.MaNganhNghe"
            type="text"
            size="small"
            :readonly="isEditor"
          ></el-input>
        </el-form-item>
        <el-form-item label="Tên Ngành nghề" prop="TenNganhNghe">
          <el-input
            v-model="formData.TenNganhNghe"
            type="text"
            size="small"
          ></el-input>
        </el-form-item>
    ...
    return {
      ...
      formRules: {
        MaNganhNghe: [
          {
            required: true,
            message: "Vui lòng nhập Mã Ngành nghề",
            trigger: "blur"
          }
        ],
        TenNganhNghe: [
          {
            required: true,
            message: "Vui lòng nhập Tên Ngành nghề",
            trigger: "blur"
          }
        ]
      },
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm("Bạn có chắc chắn muốn xóa?", "Thông báo", {
        ...
        deleteNganhNghe(row.Id).then(data => {
          this.$message({
            type: "success",
    ...
    updateData() {
      this.$refs.formData.validate(valid => {
        if (valid) {
          if (this.isEditor == 0) {
            addNganhNghe(this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          } else {
            updateNganhNghe(this.formData.Id, this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          }
    ...
    renderData() {
      var _data = this.listData.filter(post => {
        return post.TenNganhNghe.toLowerCase().includes(
