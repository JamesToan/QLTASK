  ...
  <div>
        ...
        <div class="page-title-box">
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item active">Loại văn bản</li>
            </ol>
          </div>
          <h4 class="page-title">Loại văn bản</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
      ...
      <div class="col-12">
        <div class="card-box table-responsive">
          ...
          >
            ...
            <el-table-column prop="Id" label="Mã" width="100" align="center">
            </el-table-column>
            <el-table-column
              prop="TenLoaiVanBan"
    ...
    >
      ...
      >
        ...
        <el-form-item label="Tên Loại văn bản" prop="TenLoaiVanBan">
          <el-input
            v-model="formData.TenLoaiVanBan"
            type="text"
            size="small"
          ></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm("Bạn có chắc chắn muốn xóa?", "Thông báo", {
        ...
        deleteLoaiVanBan(row.Id).then(data => {
          this.$message({
            type: "success",
    ...
    updateData() {
      this.$refs.formData.validate(valid => {
        if (valid) {
          if (this.isEditor == 0) {
            addLoaiVanBan(this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          } else {
            updateLoaiVanBan(this.formData.Id, this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          }
    ...
    renderData() {
      var _data = this.listData.filter(post => {
        return post.TenLoaiVanBan.toLowerCase().includes(
