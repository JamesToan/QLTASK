  ...
  <div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          ...
          <h4 class="page-title">Trạng thái</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
    ...
    >
      ...
      >
        ...
        <el-form-item label="Tên Trạng Thái" prop="StateName">
          <el-input
  ...
  methods: {
    ...
    updateData() {
      this.$refs.formData.validate(valid => {
        if (valid) {
          if (this.isEditor == 0) {
            addStates(this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          } else {
            updateStates( this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          }
    ...
    renderData() {
      var _data = this.listData.filter(post => {
        return (
          post.StateName.toLowerCase().includes(this.search.toLowerCase())
        );
      });
