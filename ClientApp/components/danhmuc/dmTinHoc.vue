  ...
  <div>
        ...
        <div class="page-title-box">
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item active">Tin học</li>
            </ol>
          </div>
          <h4 class="page-title">Tin học</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
    ...
    >
      <el-form
        ...
        label-width="150px"
      >
        <!-- <el-form-item label="Mã Tin học" prop="MaTinHoc">
          <el-input
            v-model="formData.MaTinHoc"
            type="text"
            size="small"
            :readonly="isEditor"
          ></el-input>
        </el-form-item> -->
        <el-form-item label="Tên Tin học" prop="TenChungChi">
          <el-input
    ...
    return {
      ...
      formRules: {
        TenChungChi: [
          {
            required: true,
            message: "Vui lòng nhập Tên Tin học",
            trigger: "blur"
          }
        ]
      },
  ...
  methods: {
    ...
    updateData() {
      this.$refs.formData.validate(valid => {
        if (valid) {
          if (this.isEditor == 0) {
            addTinHoc(this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          } else {
            updateTinHoc(this.formData.Id, this.formData).then(data => {
              //console.log(data);
              this.getListData();
            });
          }
